...
export function ServiceCatalog() {
  ...
  return (
    <section id="servicos" className="reveal-on-scroll mx-auto max-w-[1180px] px-5 py-[clamp(52px,7vw,88px)]">
      ...
      <div className="mt-[30px] flex items-center gap-3 rounded-2xl border border-ink-300 bg-white px-[18px] py-3.5 shadow-card">
      ...
      <div className="-mx-5 mt-[18px] flex gap-[9px] overflow-x-auto px-5 pb-1.5 no-scrollbar sm:mx-0 sm:flex-wrap sm:overflow-visible sm:px-0">
        {CATEGORIES.map((chip) => {
      ...
      >
        {filtered.map((service) => (
          <button
            ...
            className="flex min-h-[126px] flex-col gap-3 rounded-[15px] border border-ink-200 bg-white p-[clamp(14px,3vw,20px)] text-left transition-all hover:-translate-y-0.5 hover:border-brand-600 hover:shadow-card-hover"
          >
